    ...
    <form wire:submit="save" class="space-y-6">
        ...
        <section class="overflow-hidden bg-white border border-gray-200 shadow-sm rounded-xl">
            <div class="flex items-center gap-3 px-6 py-4 border-b border-gray-100 bg-gray-50/60">
                <span class="flex items-center justify-center flex-shrink-0 text-xs font-semibold text-white rounded-full w-7 h-7 bg-sky-600">1</span>
                <h2 class="font-semibold text-gray-900">Catalog &amp; Identification</h2>
            </div>
            <div class="p-6 space-y-5">
                <div>
                    <label>Catalog Name <span class="text-red-600">*</span></label>
        ...
        <section class="overflow-hidden bg-white border border-gray-200 shadow-sm rounded-xl">
            <div class="flex items-center gap-3 px-6 py-4 border-b border-gray-100 bg-gray-50/60">
                <span class="flex items-center justify-center flex-shrink-0 text-xs font-semibold text-white rounded-full w-7 h-7 bg-sky-600">2</span>
        ...
        <section class="overflow-hidden bg-white border border-gray-200 shadow-sm rounded-xl">
            <div class="flex items-center gap-3 px-6 py-4 border-b border-gray-100 bg-gray-50/60">
                <span class="flex items-center justify-center flex-shrink-0 text-xs font-semibold text-white rounded-full w-7 h-7 bg-sky-600">3</span>
        ...
        <section class="overflow-hidden bg-white border border-gray-200 shadow-sm rounded-xl">
            <div class="flex items-center gap-3 px-6 py-4 border-b border-gray-100 bg-gray-50/60">
                <span class="flex items-center justify-center flex-shrink-0 text-xs font-semibold text-white rounded-full w-7 h-7 bg-sky-600">4</span>
                <h2 class="font-semibold text-gray-900">Product Images <span class="font-normal text-red-600">*</span></h2>
            </div>
            <div class="p-6 space-y-4">
                    ...
                    <div class="flex flex-wrap gap-3">
                        @foreach ($existingImages as $image)
                            <div class="relative group">
                                <img src="{{ $image['url'] }}" class="object-cover w-24 h-24 border border-gray-200 rounded-lg">
                ...
                <label class="flex flex-col items-center justify-center gap-2 px-6 py-8 text-center transition-colors border-2 border-gray-300 border-dashed rounded-lg cursor-pointer hover:border-sky-400 hover:bg-sky-50/40">
                    <svg class="w-8 h-8 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5m-13.5-9L12 3m0 0l4.5 4.5M12 3v13.5" />
                    </svg>
                    <span class="text-sm text-gray-600"><span class="font-medium text-sky-600">Click to upload</span> or drag and drop images</span>
                ...
                @if ($newImages)
                    <div class="flex flex-wrap gap-3">
                        @foreach ($newImages as $upload)
                            <img src="{{ $upload->temporaryUrl() }}" class="object-cover w-24 h-24 border border-gray-200 rounded-lg">
                        @endforeach
                    </div>
                @endif
            </div>
        ...
        <section class="overflow-hidden bg-white border border-gray-200 shadow-sm rounded-xl">
            <div class="flex items-center gap-3 px-6 py-4 border-b border-gray-100 bg-gray-50/60">
                <span class="flex items-center justify-center flex-shrink-0 text-xs font-semibold text-white rounded-full w-7 h-7 bg-sky-600">5</span>
        ...
        <section class="overflow-hidden bg-white border border-gray-200 shadow-sm rounded-xl">
            <div class="flex items-center gap-3 px-6 py-4 border-b border-gray-100 bg-gray-50/60">
                <span class="flex items-center justify-center flex-shrink-0 text-xs font-semibold text-white rounded-full w-7 h-7 bg-sky-600">6</span>
        ...
        <section class="overflow-hidden bg-white border border-gray-200 shadow-sm rounded-xl">
            <div class="flex items-center gap-3 px-6 py-4 border-b border-gray-100 bg-gray-50/60">
                <span class="flex items-center justify-center flex-shrink-0 text-xs font-semibold text-white rounded-full w-7 h-7 bg-sky-600">7</span>
                ...
                <div>
                    ...
                    <div class="space-y-2 mt-1.5">
                        @foreach ($specifications as $index => $spec)
                            <div class="flex gap-2">
                                <input type="text" wire:model="specifications.{{ $index }}.key" placeholder="e.g. Color"
                                    class="block w-full text-sm border-gray-300 rounded-lg shadow-sm focus:border-sky-500 focus:ring-sky-500 focus:ring-1">
                                <input type="text" wire:model="specifications.{{ $index }}.value" placeholder="e.g. Red"
                                    class="block w-full text-sm border-gray-300 rounded-lg shadow-sm focus:border-sky-500 focus:ring-sky-500 focus:ring-1">
        ...
        <section class="overflow-hidden bg-white border border-gray-200 shadow-sm rounded-xl">
            <div class="flex items-center gap-3 px-6 py-4 border-b border-gray-100 bg-gray-50/60">
                <span class="flex items-center justify-center flex-shrink-0 text-xs font-semibold text-white rounded-full w-7 h-7 bg-sky-600">8</span>
                ...
                <div class="grid grid-cols-2 gap-5">
                    <div>
                        ...
                        <p class="text-xs text-gray-400 mt-1.5">
                            Don't know it? <a href="https://www.unspsc.org/search-code" target="_blank" class="underline text-sky-600 hover:text-sky-700">Look it up here</a>.
                        </p>
                        @error('unspscCode')
                            <p class="text-sm text-red-600 mt-1.5">{{ $message }}</p>
                        @enderror
        ...
        <section class="overflow-hidden bg-white border border-gray-200 shadow-sm rounded-xl">
            <div class="flex items-center gap-3 px-6 py-4 border-b border-gray-100 bg-gray-50/60">
                <span class="flex items-center justify-center flex-shrink-0 text-xs font-semibold text-white rounded-full w-7 h-7 bg-sky-600">9</span>
