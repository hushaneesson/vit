...
class VitFieldDefinition
{
    ...
    private const DEFINITIONS = [
        ...
        ['field_key' => 'dealer_sku', 'web_app_label' => 'Seller SKU', 'description' => "Seller's part #", 'requirement_type' => 'required', 'field_type' => 'text', 'is_system_derived' => false, 'system_source' => null, 'is_multi_value' => false, 'join_separator' => null, 'max_length' => null, 'conditional_on_field' => null, 'conditional_on_value' => null, 'sort_order' => 20],
        ...
        ['field_key' => 'selling_price', 'web_app_label' => 'Selling Price per Unit', 'description' => 'The price/unit that the buyer will pay.', 'requirement_type' => 'required', 'field_type' => 'decimal', 'is_system_derived' => false, 'system_source' => null, 'is_multi_value' => false, 'join_separator' => null, 'max_length' => null, 'conditional_on_field' => null, 'conditional_on_value' => null, 'sort_order' => 130],
