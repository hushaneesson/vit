...
class VitFieldDefinition
{
    ...
    private const DEFINITIONS = [
        ...
        [
            ...
            'append_to_field' => null,
            'shown_on_frontend' => true,
            'vit_csv_column' => 'Protected Search Terms',
            'model_attribute' => null,
            'sort_order' => 80,
            'is_key_value' => false,
        ],
        ...
        ['field_key' => 'replacement_sku', 'web_app_label' => 'Replacement Part Number', 'description' => 'SKU of the replacement product, if available', 'requirement_type' => 'optional', 'field_type' => 'text', 'is_system_derived' => false, 'system_source' => null, 'is_multi_value' => true, 'join_separator' => ',', 'is_key_value' => false, 'max_length' => 255, 'conditional_on_field' => 'discontinued', 'conditional_on_value' => 'TRUE', 'packs_into_field' => null, 'packs_into_key' => null, 'append_to_field' => null, 'shown_on_frontend' => false, 'vit_csv_column' => 'replacement Sku', 'model_attribute' => null, 'sort_order' => 280],
