...
class VitFieldDefinition
{
    ...
    private const DEFINITIONS = [
        ...
        ['field_key' => 'categorization_or_hierarchy', 'web_app_label' => 'Categorization / Hierarchy', 'description' => 'Up to 3 levels is preferred', 'requirement_type' => 'required', 'field_type' => 'text', 'is_system_derived' => false, 'system_source' => null, 'is_multi_value' => false, 'join_separator' => null, 'max_length' => null, 'conditional_on_field' => null, 'conditional_on_value' => null, 'sort_order' => 90],
        ['field_key' => 'brand_name', 'web_app_label' => 'Brand Name', 'description' => 'Brand name', 'requirement_type' => 'optional', 'field_type' => 'text', 'is_system_derived' => false, 'system_source' => null, 'is_multi_value' => false, 'join_separator' => null, 'max_length' => null, 'conditional_on_field' => null, 'conditional_on_value' => null, 'sort_order' => 100],
        ...
        ['field_key' => 'unit_of_measure', 'web_app_label' => 'Unit of Measure', 'description' => 'Unit of Measure that the item is sold for at the stated selling price per unit (ISO standard preferred)', 'requirement_type' => 'required', 'field_type' => 'text', 'is_system_derived' => false, 'system_source' => null, 'is_multi_value' => false, 'join_separator' => null, 'max_length' => null, 'conditional_on_field' => null, 'conditional_on_value' => null, 'sort_order' => 140],
        ['field_key' => 'specifications', 'web_app_label' => 'Specifications', 'description' => 'Product attributes such as dimensions, color, weight, materials, and other product-specific properties, formatted as "attribute name=attribute value"', 'requirement_type' => 'optional', 'field_type' => 'text', 'is_system_derived' => false, 'system_source' => null, 'is_multi_value' => true, 'join_separator' => ',', 'max_length' => null, 'conditional_on_field' => null, 'conditional_on_value' => null, 'sort_order' => 150],
        ...
        ['field_key' => 'quantity_per_unit', 'web_app_label' => 'Quantity per Unit', 'description' => 'Number of items within the stated unit of measure', 'requirement_type' => 'optional', 'field_type' => 'number', 'is_system_derived' => false, 'system_source' => null, 'is_multi_value' => false, 'join_separator' => null, 'max_length' => null, 'conditional_on_field' => null, 'conditional_on_value' => null, 'sort_order' => 210],
        ...
        ['field_key' => 'multiples', 'web_app_label' => 'Order Multiples', 'description' => 'If the item must be ordered in multiples of x', 'requirement_type' => 'optional', 'field_type' => 'number', 'is_system_derived' => false, 'system_source' => null, 'is_multi_value' => false, 'join_separator' => null, 'max_length' => null, 'conditional_on_field' => null, 'conditional_on_value' => null, 'sort_order' => 230],
        ...
        ['field_key' => 'msds_link', 'web_app_label' => 'MSDS Link', 'description' => 'Link where the Material Safety Data Sheet (MSDS) is hosted', 'requirement_type' => 'optional', 'field_type' => 'text', 'is_system_derived' => false, 'system_source' => null, 'is_multi_value' => false, 'join_separator' => null, 'max_length' => null, 'conditional_on_field' => null, 'conditional_on_value' => null, 'sort_order' => 250],
    ];
