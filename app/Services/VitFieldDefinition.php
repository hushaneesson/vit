...
class VitFieldDefinition
{
    ...
    private const DEFINITIONS = [
        ...
        ['field_key' => 'short_description', 'web_app_label' => 'Item Name', 'description' => "Item's name, title or short description", 'requirement_type' => 'required', 'field_type' => 'text', 'is_system_derived' => false, 'system_source' => null, 'is_multi_value' => false, 'join_separator' => null, 'max_length' => 255, 'conditional_on_field' => null, 'conditional_on_value' => null, 'packs_into_field' => null, 'packs_into_key' => null, 'append_to_field' => null, 'shown_on_frontend' => true, 'vit_csv_column' => 'name', 'model_attribute' => 'name', 'sort_order' => 60],
        ['field_key' => 'long_description', 'web_app_label' => 'Description', 'description' => 'Long description', 'requirement_type' => 'required', 'field_type' => 'text', 'is_system_derived' => false, 'system_source' => null, 'is_multi_value' => false, 'join_separator' => null, 'max_length' => 4000, 'conditional_on_field' => null, 'conditional_on_value' => null, 'packs_into_field' => null, 'packs_into_key' => null, 'append_to_field' => null, 'shown_on_frontend' => true, 'vit_csv_column' => 'description', 'model_attribute' => 'description', 'sort_order' => 70],

        // FIXED: spec marks Search Terms as required, was 'optional'
        ['field_key' => 'search_terms', 'web_app_label' => 'Search Terms', 'description' => 'Keywords, comma separated', 'requirement_type' => 'required', 'field_type' => 'text', 'is_system_derived' => false, 'system_source' => null, 'is_multi_value' => true, 'join_separator' => ',', 'max_length' => 2000, 'conditional_on_field' => null, 'conditional_on_value' => null, 'packs_into_field' => null, 'packs_into_key' => null, 'append_to_field' => null, 'shown_on_frontend' => true, 'vit_csv_column' => 'search terms', 'model_attribute' => null, 'sort_order' => 80],

        ['field_key' => 'hierarchy', 'web_app_label' => 'Hierarchy', 'description' => 'Up to 3-levels is preferred. Example: Cleaning/Paper Products/Toilet paper.', 'requirement_type' => 'required', 'field_type' => 'text', 'is_system_derived' => false, 'system_source' => null, 'is_multi_value' => false, 'join_separator' => null, 'max_length' => 255, 'conditional_on_field' => null, 'conditional_on_value' => null, 'packs_into_field' => null, 'packs_into_key' => null, 'append_to_field' => null, 'shown_on_frontend' => true, 'vit_csv_column' => 'hierarchy', 'model_attribute' => null, 'sort_order' => 90],
        ...
        ['field_key' => 'list_price', 'web_app_label' => 'List Price', 'description' => 'Manufacturer Suggested Retail Price (MSRP)', 'requirement_type' => 'required', 'field_type' => 'decimal', 'is_system_derived' => false, 'system_source' => null, 'is_multi_value' => false, 'join_separator' => null, 'max_length' => null, 'conditional_on_field' => null, 'conditional_on_value' => null, 'packs_into_field' => null, 'packs_into_key' => null, 'append_to_field' => null, 'shown_on_frontend' => true, 'vit_csv_column' => 'list price', 'model_attribute' => null, 'sort_order' => 120],

        // NOTE: csv column for this per spec is "APDcost" — check csv writer mapping.
        ['field_key' => 'selling_price', 'web_app_label' => 'Selling Price per Unit', 'description' => 'The price/unit that the buyer will pay.', 'requirement_type' => 'required', 'field_type' => 'decimal', 'is_system_derived' => false, 'system_source' => null, 'is_multi_value' => false, 'join_separator' => null, 'max_length' => null, 'conditional_on_field' => null, 'conditional_on_value' => null, 'packs_into_field' => null, 'packs_into_key' => null, 'append_to_field' => null, 'shown_on_frontend' => true, 'vit_csv_column' => 'APDcost', 'model_attribute' => null, 'sort_order' => 130],
        ...
        ['field_key' => 'specifications', 'web_app_label' => 'Specifications', 'description' => 'Product attributes such as dimensions, color, weight, materials, and other product-specific properties. The format should be "attribute name=attribute value" separated by a comma. For example: Color=Red, Materials=Aluminum, Length=25 feet.', 'requirement_type' => 'required', 'field_type' => 'text', 'is_system_derived' => false, 'system_source' => null, 'is_multi_value' => true, 'join_separator' => '|', 'max_length' => 4000, 'conditional_on_field' => null, 'conditional_on_value' => null, 'packs_into_field' => null, 'packs_into_key' => null, 'append_to_field' => null, 'shown_on_frontend' => true, 'vit_csv_column' => 'specifications', 'model_attribute' => null, 'sort_order' => 150],
        ...
        ['field_key' => 'item_weight_in_pounds', 'web_app_label' => 'Item Weight in Pounds', 'description' => 'Weight of the product, in pounds.', 'requirement_type' => 'required', 'field_type' => 'decimal', 'is_system_derived' => false, 'system_source' => null, 'is_multi_value' => false, 'join_separator' => null, 'max_length' => null, 'conditional_on_field' => null, 'conditional_on_value' => null, 'packs_into_field' => null, 'packs_into_key' => null, 'append_to_field' => null, 'shown_on_frontend' => true, 'vit_csv_column' => 'item weight', 'model_attribute' => null, 'sort_order' => 190],

        // FIXED: spec marks Selling Point as required, was 'optional'
        ['field_key' => 'selling_points', 'web_app_label' => 'Selling Points', 'description' => 'Special characteristics of the item, separated by a comma.', 'requirement_type' => 'required', 'field_type' => 'text', 'is_system_derived' => false, 'system_source' => null, 'is_multi_value' => true, 'join_separator' => '|', 'max_length' => 4000, 'conditional_on_field' => null, 'conditional_on_value' => null, 'packs_into_field' => null, 'packs_into_key' => null, 'append_to_field' => null, 'shown_on_frontend' => true, 'vit_csv_column' => 'selling points', 'model_attribute' => null, 'sort_order' => 200],
        ...
        ['field_key' => 'quantity_per_unit', 'web_app_label' => 'Quantity per Unit', 'description' => 'Number of items within the stated unit of measure. Example: If the UOM is a PK (pack), the quantity per PK may be 4. So this is a 4/PK.', 'requirement_type' => 'required', 'field_type' => 'number', 'is_system_derived' => false, 'system_source' => null, 'is_multi_value' => false, 'join_separator' => null, 'max_length' => null, 'conditional_on_field' => null, 'conditional_on_value' => null, 'packs_into_field' => null, 'packs_into_key' => null, 'append_to_field' => 'short_description', 'shown_on_frontend' => true, 'vit_csv_column' => null, 'model_attribute' => null, 'sort_order' => 210],
        ...
        ['field_key' => 'unit_word', 'web_app_label' => 'Quantity Unit Type', 'description' => 'The type of unit being counted for Quantity per Unit — e.g. "Reams", "Sheets", "Each". Combines with Quantity per Unit and the Unit of Measure to build the full quantity description, e.g. "10 Reams/CS".', 'requirement_type' => 'required', 'field_type' => 'text', 'is_system_derived' => false, 'system_source' => null, 'is_multi_value' => false, 'join_separator' => null, 'max_length' => 255, 'conditional_on_field' => null, 'conditional_on_value' => null, 'packs_into_field' => null, 'packs_into_key' => null, 'append_to_field' => null, 'shown_on_frontend' => true, 'vit_csv_column' => null, 'model_attribute' => null, 'sort_order' => 211],

        ['field_key' => 'min_qty_per_order', 'web_app_label' => 'Minimum Qty per Order', 'description' => 'Minimum quantity limit per order, if any.', 'requirement_type' => 'optional', 'field_type' => 'number', 'is_system_derived' => false, 'system_source' => null, 'is_multi_value' => false, 'join_separator' => null, 'max_length' => 11, 'conditional_on_field' => null, 'conditional_on_value' => null, 'packs_into_field' => null, 'packs_into_key' => null, 'append_to_field' => null, 'shown_on_frontend' => true, 'vit_csv_column' => 'minimum', 'model_attribute' => null, 'sort_order' => 220],
        ['field_key' => 'multiples', 'web_app_label' => 'Order Multiples', 'description' => 'If the item must be ordered in multiples of x. Example: multiple = 2 means the quantity being ordered must be divisible by 2 or in multiples of 2.', 'requirement_type' => 'optional', 'field_type' => 'number', 'is_system_derived' => false, 'system_source' => null, 'is_multi_value' => false, 'join_separator' => null, 'max_length' => 11, 'conditional_on_field' => null, 'conditional_on_value' => null, 'packs_into_field' => null, 'packs_into_key' => null, 'append_to_field' => null, 'shown_on_frontend' => true, 'vit_csv_column' => 'multiples', 'model_attribute' => null, 'sort_order' => 230],
        ['field_key' => 'max_qty_per_order', 'web_app_label' => 'Maximum Qty per Order', 'description' => 'Maximum quantity limit per order, if any.', 'requirement_type' => 'optional', 'field_type' => 'number', 'is_system_derived' => false, 'system_source' => null, 'is_multi_value' => false, 'join_separator' => null, 'max_length' => 11, 'conditional_on_field' => null, 'conditional_on_value' => null, 'packs_into_field' => null, 'packs_into_key' => null, 'append_to_field' => null, 'shown_on_frontend' => true, 'vit_csv_column' => 'maximum', 'model_attribute' => null, 'sort_order' => 240],
        ...
        // they land here.
        ['field_key' => 'image_urls', 'web_app_label' => 'Image / Video URLs', 'description' => 'Image or video URLs for the product. If VIT is hosting the images, provide filenames in .jpg or .png format instead and the app will format them. Start with the primary image, then additional images in order.', 'requirement_type' => 'required', 'field_type' => 'text', 'is_system_derived' => false, 'system_source' => null, 'is_multi_value' => true, 'join_separator' => '|', 'max_length' => null, 'conditional_on_field' => null, 'conditional_on_value' => null, 'packs_into_field' => null, 'packs_into_key' => null, 'append_to_field' => null, 'shown_on_frontend' => true, 'vit_csv_column' => 'image URLs', 'model_attribute' => 'images', 'sort_order' => 255],

        // NEW: was missing entirely. "As applicable" per spec — treated as optional.
        ['field_key' => 'discontinued', 'web_app_label' => 'Item Discontinued', 'description' => 'Enter TRUE or FALSE.', 'requirement_type' => 'optional', 'field_type' => 'boolean', 'is_system_derived' => false, 'system_source' => null, 'is_multi_value' => false, 'join_separator' => null, 'max_length' => 255, 'conditional_on_field' => null, 'conditional_on_value' => null, 'packs_into_field' => null, 'packs_into_key' => null, 'append_to_field' => null, 'shown_on_frontend' => true, 'vit_csv_column' => 'discontinued', 'model_attribute' => 'is_discontinued', 'sort_order' => 260],

        // NEW: was missing entirely. Conditional on discontinued = TRUE.
        ['field_key' => 'discontinued_date', 'web_app_label' => 'Discontinued Date', 'description' => 'The date the product was discontinued, in YYYY-MM-DD format.', 'requirement_type' => 'conditional', 'field_type' => 'text', 'is_system_derived' => false, 'system_source' => null, 'is_multi_value' => false, 'join_separator' => null, 'max_length' => 255, 'conditional_on_field' => 'discontinued', 'conditional_on_value' => 'TRUE', 'packs_into_field' => null, 'packs_into_key' => null, 'append_to_field' => null, 'shown_on_frontend' => true, 'vit_csv_column' => 'discontinuedDate', 'model_attribute' => 'discontinue_date', 'sort_order' => 270],

        // NEW: was missing entirely. Single SKU value, "as applicable".
        ['field_key' => 'replacement_sku', 'web_app_label' => 'Replacement Part Number', 'description' => 'The part number of the replacement product, if any. The replacement product must already exist in the system as its own catalog entry before it can be referenced here.', 'requirement_type' => 'optional', 'field_type' => 'text', 'is_system_derived' => false, 'system_source' => null, 'is_multi_value' => false, 'join_separator' => null, 'max_length' => 255, 'conditional_on_field' => 'discontinued', 'conditional_on_value' => 'TRUE', 'packs_into_field' => null, 'packs_into_key' => null, 'append_to_field' => null, 'shown_on_frontend' => true, 'vit_csv_column' => 'replacement Sku', 'model_attribute' => null, 'sort_order' => 280],
